...
const player_details_schema_1 = require("../schemas/player-details.schema");
    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                {
                    name: players_schema_1.Players.name,
                    schema: players_schema_1.PlayersSchema,
                },
                {
                    name: player_details_schema_1.PlayerDetails.name,
                    schema: player_details_schema_1.PlayerDetailSchema,
                },
            ]),
        ],
